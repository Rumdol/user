...
const _Q2EFbo9rNa = defineNitroPlugin(async (nitroApp) => {
...
const _9GHP3o = defineEventHandler(async (e) => {
...
const _M504rJ = defineEventHandler(async (e) => {
...
const _55hRT5 = defineEventHandler(async (e) => {
...
const _lazy_6ydn5w = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_6ydn5w, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _9GHP3o, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _M504rJ, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _55hRT5, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6ydn5w, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, getRequestHeader as A, destr as B, isEqual as C, setCookie as D, getCookie as E, deleteCookie as F, parseQuery as G, withTrailingSlash as H, withoutTrailingSlash as I, hash as J, getQuery as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, getRouteRules as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatus as h, getResponseStatusText as i, joinHeaders as j, baseURL as k, hasProtocol as l, isScriptProtocol as m, normalizeCookieHeader as n, joinURL as o, publicAssetsURL as p, defu as q, getContext as r, sanitizeStatusCode as s, createHooks as t, useNitroApp as u, toRouteMatcher as v, withQuery as w, createRouter$1 as x, klona as y, parse as z };
