import { version, unref, inject, toRaw, isRef, isReactive, toRef, ref, defineComponent, h, computed, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, onScopeDispose, defineAsyncComponent, shallowRef, isReadonly, toRefs, markRaw, withCtx, isShallow } from 'vue';
import { $ as $fetch, k as baseURL, l as hasProtocol, m as isScriptProtocol, o as joinURL, w as withQuery, c as createError$1, q as defu, s as sanitizeStatusCode, r as getContext, t as createHooks, v as toRouteMatcher, x as createRouter$1 } from '../_/nitro.mjs';
...
const __nuxt_page_meta = { middleware: "authenticate" };
const _routes = [
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./index-D704dL8k.mjs')
  },
  {
    name: "error",
    path: "/error",
    component: () => import('./error-CiqhZn6d.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-fCrtNcwr.mjs')
  },
  {
    name: "map",
    path: "/map",
    component: () => import('./index-CyAywMu6.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BupDkBmr.mjs')
  }
];
...
const namedMiddleware = {
  authenticate: () => import('./authenticate-CY38wZJr.mjs'),
  "redirect-if-authenticated": () => import('./redirectIfAuthenticated-CftVgjT9.mjs')
};
...
const vee_validate_K3WwmJMPDb = /* @__PURE__ */ defineNuxtPlugin(() => {
  configure({
    validateOnBlur: true,
    validateOnChange: true,
...
const layouts = {
  default: () => import('./default-BRlDANaF.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BzVqw6J6.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BPon51zX.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, resolveUnrefHeadInput as d, entry$1 as default, defineNuxtRouteMiddleware as e, defineStore as f, useRequestEvent as g, asyncDataDefaults as h, injectHead as i, createError as j, fetchDefaults as k, useRequestFetch as l, nuxtLinkDefaults as n, resolveRouteObject as r, storeToRefs as s, useRouter as u, zIndexContextKey as z };
